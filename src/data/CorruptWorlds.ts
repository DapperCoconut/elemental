...
export const CORRUPT_WORLDS: World[] = [
  ...
  // Tier 2: Illusion children — the drawn, the read, the loved, the mirrored.
  ...
  { id: 'glass',     name: 'Glass',     emoji: '🔷', color: 0x9fe8ff, parentId: 'illusion',  mapX: 560, mapY: 390, nodes: makeNodes('glass') },

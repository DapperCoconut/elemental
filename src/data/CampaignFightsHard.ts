...
export const CAMPAIGN_FIGHTS_HARD: Record<string, CampaignFightDef> = {
  ...
  'fire-fight-1':   { enemyElementId: 'plasma',    difficulty: 3, name: 'Second Spark',    taunt: 'The echo remembers you winning. It has notes.', mutations: ['tempest'] },
  ...
  // ── Water ─────────────────────────────────────────────────────────
  'water-fight-1':   { enemyElementId: 'ice',     difficulty: 4, name: 'The Tide, Frozen',  taunt: 'The echo paused the wave you dodged. Mid-crest.', mutations: ['frostbite'] },
  ...
  // ── Life ──────────────────────────────────────────────────────────
  'life-fight-1':   { enemyElementId: 'death',  difficulty: 4, name: 'The Compost Turn',  taunt: 'In the echo, the garden tends the gardener.', mutations: ['bramble'] },
  ...
  // ── Air ───────────────────────────────────────────────────────────
  'air-fight-1':   { enemyElementId: 'sound',       difficulty: 4, name: 'The Scream In The Draft', taunt: 'The wind kept everything you said in that fight.', mutations: ['maelstrom'] },
  ...
  // ── Earth ─────────────────────────────────────────────────────────
  'earth-fight-1':   { enemyElementId: 'ruin',     difficulty: 4, name: 'Bedrock, Broken', taunt: 'You moved the mountain. The echo shows you what fell out.', mutations: ['quicksand'] },
  ...
  // ── Ice ───────────────────────────────────────────────────────────
  'ice-fight-1':   { enemyElementId: 'dune',    difficulty: 4, name: 'First Frost, Buried', taunt: 'Frozen once, buried once. The echo kept the grains.', mutations: ['frostbite'] },
  ...
  // ── Growth ────────────────────────────────────────────────────────
  'growth-fight-1':   { enemyElementId: 'radiation', difficulty: 4, name: 'Mutation Rate', taunt: 'The petri dish met something that speeds evolution up.', mutations: ['swarm'] },
  ...
  // ── Crystal ───────────────────────────────────────────────────────
  'crystal-fight-1':   { enemyElementId: 'dune',   difficulty: 4, name: 'Geode, Buried', taunt: 'You opened the geode. The echo poured the desert into it.', mutations: ['fragile'] },
  ...
  // ── Hunt ──────────────────────────────────────────────────────────
  'hunt-fight-1':   { enemyElementId: 'hunt',    difficulty: 4, name: 'The Scent, Reversed', taunt: 'In the second telling, you smell like prey from the start.', mutations: ['feast'] },
  ...
  // ── Creation ──────────────────────────────────────────────────────
  'creation-fight-1':   { enemyElementId: 'technology', difficulty: 4, name: 'The Workshop, Automated', taunt: 'I built a machine that builds machines that dislike you.', mutations: ['overload'] },
  ...
  // ── Time (world id `sand`) ────────────────────────────────────────
  'sand-fight-1':   { enemyElementId: 'echo',    difficulty: 4, name: 'The Hourglass, Turned', taunt: 'This is the same minute you already won. Feel it fighting back.', mutations: ['rewind'] },
  ...
  // ── Electricity ───────────────────────────────────────────────────
  'electricity-fight-1':   { enemyElementId: 'magnet',   difficulty: 4, name: 'Reverse Polarity', taunt: 'The echo ran the current backwards to see what fell out. You did.', mutations: ['tempest'] },
  ...
  // ── Acid (world id `slime`) ───────────────────────────────────────
  'slime-fight-1':   { enemyElementId: 'gum',     difficulty: 4, name: 'The Vat, Thickened', taunt: 'It stopped dissolving things and started keeping them.', mutations: ['hydra'] },
  ...
  // ── Fate ──────────────────────────────────────────────────────────
  'fate-fight-1':   { enemyElementId: 'fortune', difficulty: 4, name: 'The Rake', taunt: 'The house heard you beat the dealer. The house has questions.', mutations: ['roulette'] },
  ...
  // ── Metal ─────────────────────────────────────────────────────────
  'metal-fight-1':   { enemyElementId: 'earth',   difficulty: 4, name: 'The Ore Answers', taunt: 'The legion went back into the ground. The ground came back up.', mutations: ['bulwark'] },
  ...
  // ── Plasma ────────────────────────────────────────────────────────
  'plasma-fight-1':   { enemyElementId: 'electricity', difficulty: 4, name: 'Ionised Again', taunt: 'The echo could not hold the shape either. It is trying anyway.', mutations: ['overload'] },
  ...
  // ── Gunpowder ─────────────────────────────────────────────────────
  'gunpowder-fight-1':   { enemyElementId: 'oil',       difficulty: 4, name: 'Fresh Powder', taunt: 'The echo restocked. It restocked a great deal.', mutations: ['duel'] },
  ...
  // ── Silence ───────────────────────────────────────────────────────
  'silence-fight-1':   { enemyElementId: 'shadow',  difficulty: 4, name: 'The Understudy Waits', taunt: 'It has been practising your walk in the dark.', mutations: ['doppel'] },
  ...
  // ── Magic ─────────────────────────────────────────────────────────
  'magic-fight-1':   { enemyElementId: 'creation', difficulty: 4, name: 'The Restricted Section', taunt: 'The echo got a library card. It should not have one.', mutations: ['vault'] },
  ...
  // ── Illusion ──────────────────────────────────────────────────────
  'illusion-fight-1':   { enemyElementId: 'dune',     difficulty: 5, name: 'The House Shimmers', taunt: 'The stage found a mirage. Now there are two of everything, and one of you.', mutations: ['doppel'] },
  ...
  // ── Conquest ──────────────────────────────────────────────────────
  'conquest-fight-1':   { enemyElementId: 'metal',    difficulty: 5, name: 'The Muster', taunt: 'You took the high ground. The echo brought a second army to it.', mutations: ['bulwark'] },
  ...
  // ── Gluttony ──────────────────────────────────────────────────────
  'gluttony-fight-1':   { enemyElementId: 'gum',      difficulty: 5, name: 'The Kitchen Floor', taunt: 'Everything spilled here is still here, and it has opinions about you.', mutations: ['feast'] },
  ...
  // ── Cloth ────────────────────────────────────────────────────────
  'cloth-fight-1':   { enemyElementId: 'ice',    difficulty: 5, name: 'Setting The Seam',   taunt: 'The hall called in a second pair of hands. It holds what I cannot hem.', mutations: ['frostbite'] },
  ...
  // ── Bind ──────────────────────────────────────────────────────────
  'bind-fight-1':   { enemyElementId: 'metal',  difficulty: 5, name: 'New Chain, Old Ring', taunt: 'The gaol replaced everything you broke and shortened it a little.', mutations: ['vault'] },
  ...
  'bind-fight-5':   { enemyElementId: 'bind',   difficulty: 5, name: 'The Gaoler, Doubled', taunt: 'Every cell in the realm has a name on it. I have run out of other names.', mutations: ['warden', 'titanic'], starredMutations: ['titanic'] },
  ...
  // ── Chalk ─────────────────────────────────────────────────────────
  'chalk-fight-1':   { enemyElementId: 'illusion', difficulty: 5, name: 'The Blackboard Lies', taunt: 'Drawn and pretended are neighbours. They have knocked through.', mutations: ['inversion'] },
  ...
  // ── Psychic ───────────────────────────────────────────────────────
  'psychic-fight-1':   { enemyElementId: 'dream',   difficulty: 5, name: 'The Room Throbs', taunt: 'It has stopped being your idea that you came in here.', mutations: ['inversion'] },
  ...
  'psychic-fight-5':   { enemyElementId: 'psychic', difficulty: 5, name: 'The Overmind, Certain', taunt: 'One of us is imagining the other. I have stopped asking which.', mutations: ['oracle', 'pain'], starredMutations: ['pain'] },

  // ── Passion ───────────────────────────────────────────────────────
  'passion-fight-1':   { enemyElementId: 'sound',   difficulty: 5, name: 'The Court Keeps Time', taunt: 'The floor has a heartbeat and it has learned your name.', mutations: ['bramble'] },
  ...
  // ── Sand ──────────────────────────────────────────────────────────
  'dune-fight-1':   { enemyElementId: 'crystal', difficulty: 5, name: 'The Higher Ledge', taunt: 'The hall added storeys. Every one of them is looking down at you.', mutations: ['quicksand'] },
  ...
  // ── Fortune ───────────────────────────────────────────────────────
  'fortune-fight-1':   { enemyElementId: 'fate',    difficulty: 5, name: 'The House Rules', taunt: 'Luck came in to complain. Luck now works the door.', mutations: ['roulette'] },
  ...
  // ── Radiation ─────────────────────────────────────────────────────
  'radiation-fight-1':   { enemyElementId: 'slime',     difficulty: 5, name: 'Hot Runoff', taunt: 'The zone drains into something. The something is awake.', mutations: ['contagion'] },
  ...
  // ── Depths ────────────────────────────────────────────────────────
  'depths-fight-1':   { enemyElementId: 'water',  difficulty: 5, name: 'The Column Above', taunt: 'Everything the surface dropped is down here. So is the surface, now.', mutations: ['maelstrom'] },
  ...
  'gum-fight-1':   { enemyElementId: 'oil',   difficulty: 5, name: 'The Floor Keeps It', taunt: 'Whatever momentum you bring, I am still holding the last lot.', mutations: ['hydra'] },

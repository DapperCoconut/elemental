...
export const ALL_UPGRADES: ElementUpgrades[] = [
  ...
  {
    elementId: 'adrenaline',
    upgrades: [
      {
        slot: 'click',
        displayKey: 'Click',
        name: 'Weapon Cycle',
        description: '1/2/3 switches Pistol/Shotgun/Nail Gun. Switching grants Fresh! (+50% style) for 1.5s.',
        price: 100,
        currency: 'corrupt',
      },
      {
        ...
        displayKey: 'E',
        name: 'Parry Dash',
        description: 'E (and Q) dash parries enemy projectiles: 30 dmg auto-aimed fireball + Feedback style.',
        price: 200,
        currency: 'corrupt',
      },
      {
        ...
        displayKey: 'R',
        name: 'Skate Mastery',
        description: 'Rush boosts accel. 2x ramp lifetime, 2 ramps. Super Zoom / UBER Trick / WOAH combos.',
        price: 350,
        currency: 'corrupt',
      },
      {
        slot: 'f',
        displayKey: 'F',
        name: 'Compound Inject',
        description: 'Recast F during Phase 1 to extend (up to 3x). Each extend doubles Phase 2 duration+severity.',
        price: 500,
        currency: 'corrupt',
      },
      {
        ...
        displayKey: 'Q',
        name: 'P Tier',
        description: 'Maintain S for 10s to enter P: +50% speed, +50% dmg, purple aura. Must hit every 1s.',
        price: 750,
        currency: 'corrupt',
      },
    ],

  ...
  },
  {
    ...
    upgrades: [
      ...
      },
      {
        ...
        displayKey: 'Q',
        name: 'Tree of Life',
        description: 'Hold Q 3s to transform your nearest plant into a Tree of Life that drops 6 golden apples over 6s. Apples heal 15 on pickup; collecting all 6 triggers a 3s poison-puddle fountain at your cursor. Unpicked apples rot after 5s and deal 15 dmg to enemies on contact, disappearing 5s later.',
        price: 75,
      },
    ],
  },
    ...
    upgrades: [
      {
        ...
        displayKey: 'Click',
        name: 'Compose',
        description: 'Hold Click 2s to enter Composing Mode: freeze the bar and drag notes onto it (20-pt budget). Blue note=slow 30% 2s; Purple note=+25% speed 3s. Pattern loops replacing random spawns.',
        price: 100,
        currency: 'corrupt',
      },
      {
  ...
  },
  {
    ...
    upgrades: [
      ...
      },
      {
        ...
        displayKey: 'R',
        name: 'Voodoo / Red Pip',
        description: 'Possess leaves a voodoo doll (hit = +20% dmg on enemy). Mortal Wound heal-stops 10s + red pip +25% spd.',
        price: 350,
        currency: 'corrupt',
      },
      {

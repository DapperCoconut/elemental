...
export const MUTATIONS: MutationDef[] = [
  ...
  },
  {
    ...
    fullDesc: '+50% size, ×1.5 HP, −34% speed, takes 8% less damage. Every 10 seconds summons up to 5 zombies from the arena borders — each has 20 HP and attacks in melee for 4 — and no more than 14 may stand on the floor at once. At 50% HP: takes a further 8% less damage, and each dead zombie leaves one fast zombieling (10 HP, drops a toxic puddle on death). With 12+ zombies active, the Summoner heals 15 HP (up to once every 12 seconds).',
    starredDesc: '',
    rewardMult: 2.0,
    unlockedByDefault: false,
    bossOnly: true,

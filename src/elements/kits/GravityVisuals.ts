 ...
 *
 * Colours must come from the GRAVITY palette below. Gravity has no colour-slot cosmetic yet, but
...
/** `(base) => displayed` — CosmeticsKit.gravityColor bound to one owner. */
